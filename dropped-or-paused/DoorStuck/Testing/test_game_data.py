...
class DatabaseHandlerTest(unittest.TestCase):
    ...
    def test_add_devcards_to_db(self):
        ...
        self.assertEqual(result, [
            ...
            (2, 'None', 'get_new_item', 'None', '4', 'Something icky in your mouth', 'lose_1_health',
             'Board with Nails'),
            ...
            (8, 'Your body shiver uncontrollably', 'None', 'You feel a spark of hope', 'add_1_health', 'None', '4',
             'Candle')
        ])
