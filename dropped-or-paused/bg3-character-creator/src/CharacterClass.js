...
const classes = [
  ...
  new CharacterClass('Fighter', ['Champion', 'Battle Master', 'Eldritch Knight']),
  new CharacterClass('Monk', ['Way of the Open Hand', 'Way of Shadow', 'Way of the Four Elements']),
  new CharacterClass('Paladin', ['Oath of Devotion', 'Oath of the Ancients', 'Oath of Vengeance']),
  ...
  new CharacterClass('Warlock', ['The Archfey', 'The Fiend', 'The Great Old One']),
  new CharacterClass('Wizard', ['School of Evocation', 'School of Abjuration'])
];
